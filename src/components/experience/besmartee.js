                        ...
                        <Col xs={12} sm={{ span: 10, offset: 1 }} md={{ span: 8, offset: 2 }}>
                            <div className="experience-details-section border-left border-bento-light-3 mb-2">
                                ...
                                <ul className={`font-secondary font-weight-light ${this.state.showPDTDetails ? '' : ' d-none '}`}>
                                    <li>
                                        Provided quick resolution for production level defects, ensuring minimal interruption to business operation
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        Provided guidance for new/Jr developers on debugging defects and identifying long-term enhancements
                                    </li>
                                </ul>
                            </div>
                        </Col>
                        ...
                        <Col xs={12} sm={{ span: 10, offset: 1 }} md={{ span: 8, offset: 2 }}>
                            <div className="experience-details-section border-left border-bento-light-3 mb-2">
                                ...
                                <ul className={`font-secondary font-weight-light ${this.state.showImpDetails ? '' : ' d-none '}`}>
                                    ...
                                    <li>
                                        Provided guidance and advice for other developers on developing new features and fixing bugs
                                    </li>
                                </ul>
                            </div>
                        </Col>
